!function (e) {
    ...
    !function () {
        ...
        function t(e, t) {
            ...
            var u = n.timing, d = n.memory, l = e || i(), p = document.referrer || "", v = y[2] || y[1] || y[0], h = {
            ...
            if (h.documentWriteIntervention = a(), h.firstPaint = o("first-paint"), h.firstContentfulPaint = o("first-contentful-paint"), h.errorCount = window.__cfErrCount || 0, b && (h.largestContentfulPaint = b.lcp && void 0 !== b.lcp.value ? b.lcp.value : -1, h.firstInputDelay = b.fid && void 0 !== b.fid.value ? b.fid.value : -1, h.cumulativeLayoutShift = b.cls && void 0 !== b.cls.value ? b.cls.value : -1), R && g && (h.siteToken = g.token, T = !0), "function" == typeof n.getEntriesByType) {
                var E = n.getEntriesByType("resource"), _ = 0, L = 0;
        ...
        var n = window.performance || window.webkitPerformance || window.msPerformance || window.mozPerformance,
            ...
            m = p(), y = [], g = window.__cfBeacon ? window.__cfBeacon : {};
        if (!g || "single" !== g.load) {
            var w, h, S = !1, T = !1;
            ...
            var b = {lcp: void 0, cls: void 0, fid: void 0}, E = function (e) {
                var t = window.location.pathname;
                "CLS" === e.name ? b.cls = {value: e.value, path: t} : "FID" === e.name ? b.fid = {
                    value: e.value,
                    path: t
            ...
            if ("function" == typeof PerformanceObserver && (l.getLCP(E, !0), l.getFID(E), PerformanceObserver.supportedEntryTypes && PerformanceObserver.supportedEntryTypes.includes("layout-shift") && l.getCLS(E, !0)), v) {
                ...
                if (_) try {
                    ...
                    if (L && "function" == typeof URLSearchParams) {
                        var C = new URLSearchParams(L.replace(/^[^\?]+\??/, "")), P = C.get("token");
                        P && (g.token = P);
                        var O = C.get("spa");
                        g.spa = null === O || "true" === O
                    }
            ...
            var R = !(!g || !g.token), B = g && (void 0 === g.spa || !0 === g.spa);
                    ...
                    k = function (e) {
                        var n = function (e, t, n) {
                            i.resources = e, 0 != t && (i.bypassTiming = !0), g && (1 === g.r && (i.resources = []), R && B && 0 === t && (y.push({
                                id: i.pageloadId,
                                url: i.location
                            }), y.length > 3 && y.shift()), d.sendObjectBeacon(n, i, function () {
                            }, !1, I), void 0 !== g.forward && void 0 !== g.forward.url && d.sendObjectBeacon(n, i, function () {
                            }, !1, g.forward.url))
                        }, i = t(e);
                        if (i && g) {
                            var r = "req_id=" + g.rayId, o = i.tempResources;
                        ...
                        n || (i.resources = [], delete i.tempResources), g && d.sendObjectBeacon("req_id=" + g.rayId, i, function () {
                        }, !0, I)
                    }, j = function () {
                        T = !0;
    ...
    function i(e, t, n, i, r) {
        ...
        var o = r || (t.siteToken && t.versions.fl ? "/cdn-cgi/rum?" + e : "/cdn-cgi/beacon/performance?" + e), a = !0;
    ...
    var i, r, o, a, c = function (e, t) {
        ...
        u || "undefined" != typeof InstallTrigger || (addEventListener("beforeunload", function () {
        }), u = !0), addEventListener("visibilitychange", function n(i) {
        ...
        var n, i = w(), r = c("FCP"), o = s("paint", function (e) {
    ...
    }, S = {passive: !0, capture: !0}, T = new Date, b = function (e, t) {
        ...
        var n, o = w(), u = c("FID"), v = function (e) {
        ...
        var n, i = w(), r = c("LCP"), o = function (e) {
            var t = e.startTime;
